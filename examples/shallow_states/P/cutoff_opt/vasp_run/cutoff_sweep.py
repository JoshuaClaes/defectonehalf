...
# input
sc = 2 # supercell size set to 2x2x2 for testing and 4x4x4 for actual calculation
my_vasp_cmd = 'mpirun -np 12 --map-by ppr:12:socket:PE=1 --bind-to core -x OMP_NUM_THREADS=3 -x OMP_STACKSIZE=512m -x OMP_PLACES=cores -x OMP_PROC_BIND=close --report-bindings /home/cmt/vasp.6.4.3/bin/vasp_gam'
